                    ...
                    <form><!---->
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group"><label for="name">Name *</label> <input placeholder="name" class="form-control"></div> <!----></div> <!----></div>
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="form-group"><label for="body">Body *</label>
                            <div class="tinymce">
                                ...
                                <div class="tinymce__init-area" id="mce_0" style="display: none;" aria-hidden="true"></div>
